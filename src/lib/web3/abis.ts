...
// Re-export all ABIs
export * from './abis/ProfileRegistry'
export * from './abis/AccessControl'
export * from './abis/Metadata'
export * from './abis/ProfileSystem'
export * from './abis/TierContracts'

// Alias for backward compatibility
export { PROFILE_REGISTRY_ABI as PROFILE_SYSTEM_ABI } from './abis/ProfileRegistry'
